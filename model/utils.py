...
def postprocess_args(args):
    ...
    save_path2='n_aug'+'_'+str(args.n_aug)+'seed'+'_'+str(args.seed)+'lr'+'_'+str(args.lr)
...
def get_command_line_parser():
    ...
    parser.add_argument('--learn_temperature', action='store_true', default=True)
    #loss type
    parser.add_argument('--use_euclidean', action='store_true', default=False)
    #cosine_参数loss
    parser.add_argument('--loss_type', type=str, default='VMF',choices=['VMF','cross_entropy'])#when use_euclidean,loss_type can not be VMF
    parser.add_argument('--kappa', type=float, default=1)#only make sense when loss_type choose VMF
    #AS参数
    parser.add_argument('--n_aug', type=int, default=30)


    #prrto_loss参数
    parser.add_argument('--proto_ratio', type=float, default=0.0)
    # p_noise参数
    ...
    parser.add_argument('--backbone_class', type=str, default='Res12',
                        choices=['ConvNet', 'ConvNet6', 'Res12', 'Res18', 'WRN'])
