...
from model.dataloader.samplers import CategoriesSampler, test_CategoriesSampler,RandomSampler, ClassSampler
...
def prepare_model(args):
    ...
    if args.init_weights is not None:
        ...
        # pretrained_dict = {k: v for k, v in model_dict.items() if k not in pretrained_dict}
